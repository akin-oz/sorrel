...
needs the enforcement layer that makes the thesis true — *I do not prevent the
model from being wrong, I make wrong un-mergeable* — wired as hooks/agents/commands,
